...
public class CreateContestCommand implements ICommand{
    ...
    public void execute(List<String> tokens) {
        try {
            ...
            if (tokens.size() > 4) {
                int numQuestions = Integer.parseInt(tokens.get(4));
                Contest contest = contestService.create(contestName, level, contestCreator, numQuestions);
            ...
            System.out.println("Contest Creator for given name: " + e.getMessage() + " not found!");
            ...
            System.out.println("Invalid input provided. Please check the input format.");
