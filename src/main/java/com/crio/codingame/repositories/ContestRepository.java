...
public class ContestRepository implements IContestRepository {
    ...
    public Contest save(Contest entity) {
        if (entity.getId() == null) {
            ...
            Contest newContest = new Contest(newId, entity.getName(), entity.getQuestions(), entity.getLevel(), entity.getCreator(), entity.getContestStatus());
            contestMap.put(newId, newContest);
            return newContest;
        } else {
