...
public class QuestionService implements IQuestionService{
    ...
    public List<Question> getAllQuestionLevelWise(Level level) {
       if(level==null)
       {
        return questionRepository.findAll();//this is the method to find all questions when level is not specified
       }else
        return questionRepository.findAllQuestionLevelWise(level);//this is the method to find all questions when level is specified
